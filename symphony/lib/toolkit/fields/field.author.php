...
class FieldAuthor extends Field implements ExportableField
{
    ...
    public function displaySettingsPanel(XMLElement &$wrapper, $errors = null)
    {
        ...
        $label->appendChild(Widget::Select('fields['.$this->get('sortorder').'][author_types][]', $options, array(
                'multiple' => 'multiple'
                ))
        );
    ...
    public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
    {
        ...
        // A dummy to prevent saving the first value
        $dummy = new XMLElement('option', __('Please choose...'));
